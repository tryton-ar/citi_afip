...
setup(name=name,
    ...
    package_dir={'trytond.modules.citi_afip': '.'},
    packages=[
        'trytond.modules.citi_afip',
        'trytond.modules.citi_afip.tests',
        ],
    package_data={
    ...
    entry_points="""
    [trytond.modules]
    citi_afip = trytond.modules.citi_afip
    """,
    test_suite='tests',
